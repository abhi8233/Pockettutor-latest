            ...
            <div class="col-12 col-md-6">
                <form method="" action="" class="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Enter secret key" class="form-control" name="plan-name">
                    </div>

                    <div class="mb-5">
                        <label for="email" class="col-form-label p-0 mb-1">Public Key <span class="pt-color-red pt-fs-16">*</span> </label>
                        <input type="text" placeholder="Enter public key" class="form-control" name="plan-name">
                    </div>
